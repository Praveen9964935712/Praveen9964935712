...
- **Backend Development:** Node.js, Flask, JWT Authentication, REST APIs
- **Databases:** MySQL, MongoDB, Database Design
- **Tools & Deployment:** Git, GitHub, Postman, VS Code, Vercel
- **Core Java:** OOP, Collections Framework, Exception Handling, JDBC, Multithreading

## What I build

- Responsive user interfaces with React and Tailwind CSS
- Scalable REST APIs using Node.js/Express and Flask
- Data-driven applications with MySQL / MongoDB
